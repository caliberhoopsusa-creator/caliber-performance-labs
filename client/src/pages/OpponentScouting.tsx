  ...
  return (
    <Paywall requiredTier="coach_pro" featureName="Opponent Scouting">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold font-display tracking-wide bg-gradient-to-b from-white to-accent/20 bg-clip-text text-transparent" data-testid="page-title">
            Opponent Scouting
          </h1>
