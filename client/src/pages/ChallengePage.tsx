  ...
  if (!challengerId) {
    return (
      <div className="text-center py-20">
        ...
        <h2 className="text-xl font-bold text-foreground mb-2" data-testid="text-invalid-challenge">Invalid Challenge</h2>
    ...
    <div className="pb-24 md:pb-8 max-w-2xl mx-auto space-y-6" data-testid="page-challenge">
      ...
      <div className="grid grid-cols-2 gap-4">
        <Card className="p-4 to-card/80 border-red-500/20 text-center" data-testid="card-challenger">
          ...
          <h3 className="text-lg font-bold text-foreground" data-testid="text-challenger-name">{p1?.name || 'Unknown'}</h3>
        ...
        <Card className="p-4 to-card/80 border-blue-500/20 text-center" data-testid="card-opponent">
          {p2 ? (
            <>
              ...
              <h3 className="text-lg font-bold text-foreground" data-testid="text-opponent-name">{String(p2.stats.name)}</h3>
                ...
                <div className="w-full space-y-2 px-2">
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="h-8 pl-7 text-xs bg-muted/50 border-border"
                  ...
                  {searchResults.filter(p => p.id !== challengerId).slice(0, 3).map(p => (
                    <button
                      ...
                      className="w-full flex items-center gap-2 p-1.5 rounded-md bg-muted/50 cursor-pointer text-left hover-elevate"
        ...
        <Card className="bg-muted/50 border-border overflow-visible" data-testid="card-stats-comparison">
          ...
          {p2 && (
            ...
            >
              ...
              <p className="text-sm font-bold text-foreground" data-testid="text-winner">
                {p1Wins > p2Wins 
