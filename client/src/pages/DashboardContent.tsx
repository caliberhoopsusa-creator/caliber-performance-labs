...
type SortKey = 'name' | 'position' | 'avgGradeScore' | 'ppg' | 'rpg' | 'apg' | 'spg' | 'bpg' | 'gamesPlayed' | 'passYpg' | 'rushYpg' | 'recYpg' | 'tdsPerGame' | 'tackles';
...
export default function DashboardContent() {
  ...
  const effectiveSport: string = 'basketball';
  ...
  const availablePositions = BASKETBALL_POSITIONS;
