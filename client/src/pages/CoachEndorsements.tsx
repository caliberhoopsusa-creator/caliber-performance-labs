...
export default function CoachEndorsements() {
  const { user } = useAuth();
  ...
  if (selectedPlayerId) {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-[hsl(220,25%,6%)] via-[hsl(220,20%,4%)] to-[hsl(220,25%,2%)] p-4 md:p-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Write recommendations for players to help them get recruited
              </p>
            </div>
          </div>
