...
export function SkeletonCard({ className }: { className?: string }) {
  return (
    <div className={cn("relative rounded-xl border border-cyan-500/[0.08] bg-gradient-to-br from-[hsl(220,25%,8%)] via-[hsl(220,20%,6%)] to-[hsl(220,25%,5%)] p-6 overflow-hidden", className)}>
...
export function SkeletonPlayerCard({ className }: { className?: string }) {
  return (
    <div className={cn("relative rounded-xl border border-cyan-500/[0.08] bg-gradient-to-br from-[hsl(220,25%,8%)] via-[hsl(220,20%,6%)] to-[hsl(220,25%,5%)] p-4 overflow-hidden", className)}>
      <div className="absolute inset-x-[10%] top-0 h-px bg-gradient-to-r from-transparent via-cyan-400/20 to-transparent" />
...
export function SkeletonLeaderboardRow({ className }: { className?: string }) {
  return (
    <div className={cn("flex items-center gap-4 p-4 rounded-xl border border-white/[0.05] bg-white/[0.02]", className)}>
...
export function SkeletonStatCard({ className }: { className?: string }) {
  return (
    <div className={cn("relative rounded-xl border border-cyan-500/[0.08] bg-gradient-to-br from-[hsl(220,25%,8%)] via-[hsl(220,20%,6%)] to-[hsl(220,25%,5%)] p-4 text-center overflow-hidden", className)}>
