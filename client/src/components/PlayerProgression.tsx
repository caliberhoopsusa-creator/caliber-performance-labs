...
const TIER_CONFIG: Record<string, { icon: typeof Star; color: string; bgGradient: string }> = {
  Rookie: { 
    ...
    bgGradient: "from-gray-500/10 dark:from-gray-500/20 to-gray-600/10" 
  },
  Starter: { 
    icon: Zap, 
    color: "text-green-600 dark:text-green-400", 
    bgGradient: "from-green-500/10 dark:from-green-500/20 to-green-600/10" 
  },
  "All-Star": { 
    icon: Sparkles, 
    color: "text-blue-600 dark:text-blue-400", 
    bgGradient: "from-blue-500/10 dark:from-blue-500/20 to-blue-600/10" 
  },
  MVP: { 
    icon: Trophy, 
    color: "text-purple-600 dark:text-purple-400", 
    bgGradient: "from-purple-500/10 dark:from-purple-500/20 to-purple-600/10" 
  },
  "Hall of Fame": { 
    icon: Crown, 
    color: "text-yellow-600 dark:text-yellow-400", 
    bgGradient: "from-yellow-500/10 dark:from-yellow-500/20 to-yellow-600/10" 
  },
};
  ...
  return (
    ...
    >
          ...
          {progression.streakInGracePeriod && (
            ...
            >
              ...
              <div className="flex items-center gap-2">
                <span className="text-xs font-semibold text-yellow-600 dark:text-yellow-400">Grace Period</span>
                <div className="flex items-center gap-1">
                  <Clock className="w-3 h-3 text-yellow-600 dark:text-yellow-400" />
                  <span className="text-xs text-yellow-600 dark:text-yellow-400">{progression.hoursUntilStreakLost}h</span>
                </div>
              </div>
            </motion.div>
          )}
      ...
      <div className="space-y-3">
        ...
        {!progression.nextTier && (
          <div className="text-center text-xs text-yellow-600 dark:text-yellow-400 font-bold mt-3 px-3 py-2 bg-yellow-500/10 rounded-lg border border-yellow-500/20 animate-pulse">
